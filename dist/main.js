(function() {
    ...
    e = function() {
            ...
            return e.prototype.hasNext = function() {
                ...
                var t, n, r, i, o, s, a, u, l, c, f, p, d, h, g, m, v, y, x, b, w, T, C, k, E, N, S, j, D, A, q, L, H;
                if ("object" != typeof e) {
                ...
                if (null != this.options.success && "function" == typeof this.options.success && this.options.success.call(this, e), this.context.nextUrl = "", null != e.pagination && (this.context.nextUrl = e.pagination.next_url), "none" !== this.options.sortBy) switch (q = "random" === this.options.sortBy ? ["", "random"] : this.options.sortBy.split("-"), A = "least" === q[0], q[1]) {
                    case "random":
                ...
                if ("undefined" != typeof document && null !== document && this.options.mock === !1) {
                    if (m = e.data, D = parseInt(this.options.limit, 10), null != this.options.limit && m.length > D && (m = m.slice(0, D)), a = document.createDocumentFragment(), null != this.options.filter && "function" == typeof this.options.filter && (m = this._filter(m, this.options.filter)), null != this.options.template && "string" == typeof this.options.template) {
                        for (l = "", h = "", b = "", H = document.createElement("div"), f = 0, E = m.length; E > f; f++) {
                            if (p = m[f], d = p.images[this.options.resolution], "object" != typeof d) throw s = "No image found for resolution: " + this.options.resolution + ".", new Error(s);
                            w = d.width, y = d.height, x = "square", w > y && (x = "landscape"), y > w && (x = "portrait"), g = d.url, c = window.location.protocol.indexOf("http") >= 0, c && !this.options.useHttp && (g = g.replace(/https?:\/\//, "//")), h = this._makeTemplate(this.options.template, {
                                model: p,
                                id: p.id,
                                link: p.link,
                                type: p.type,
                        ...
                        for (H.innerHTML = l, i = [], r = 0, n = H.childNodes.length; n > r;) i.push(H.childNodes[r]), r += 1;
                        for (C = 0, N = i.length; N > C; C++) j = i[C], a.appendChild(j)
                    } else
                        for (k = 0, S = m.length; S > k; k++) {
                            if (p = m[k], v = document.createElement("img"), d = p.images[this.options.resolution], "object" != typeof d) throw s = "No image found for resolution: " + this.options.resolution + ".", new Error(s);
                            g = d.url, c = window.location.protocol.indexOf("http") >= 0, c && !this.options.useHttp && (g = g.replace(/https?:\/\//, "//")), v.src = g, this.options.links === !0 ? (t = document.createElement("a"), t.href = p.link, t.appendChild(v), a.appendChild(t)) : a.appendChild(v)
                        }
                    if (L = this.options.target, "string" == typeof L && (L = document.getElementById(L)), null == L) throw s = 'No element with id="' + this.options.target + '" on page.', new Error(s);
                    L.appendChild(a), u = document.getElementsByTagName("head")[0], u.removeChild(document.getElementById("instafeed-fetcher")), T = "instafeedCache" + this.unique, window[T] = void 0;
                    try {
                        delete window[T]
                    } catch (O) {
                        o = O
                ...
                return r = function(e, r) {
                    var i, o;
                    return i = this._getObjectProperty(e, t), o = this._getObjectProperty(r, t), n ? i > o ? 1 : -1 : o > i ? 1 : -1
                }, e.sort(r.bind(this)), e
            }, e.prototype._filter = function(e, t) {
                var n, r, i, o, s;
                for (n = [], r = function(e) {
                        return t(e) ? n.push(e) : void 0
                    }, i = 0, s = e.length; s > i; i++) o = e[i], r(o);
                return n
            }, e
        }(),
        function(e, t) {
    ...
    function(e, t) {
        ...
        function p(e, t, n, r, i) {
            ...
            for (d.textContent = "", g = 0; o = h[g++];)
                ...
                for (p = 0; o = s[p++];) Ie.test(o.type || "") && n.push(o);
            return d
        }
        ...
        function T(e, t, n, r) {
            ...
            var i, o, s, a, u, l, f = 0,
                ...
                g = t[0],
                m = oe.isFunction(g);
            if (m || d > 1 && "string" == typeof g && !re.checkClone && We.test(g)) return e.each(function(i) {
                var o = e.eq(i);
            ...
            if (d && (i = p(t, e[0].ownerDocument, !1, e, r), o = i.firstChild, 1 === i.childNodes.length && (i = o), o || r)) {
                ...
                if (a)
                    for (l = s[s.length - 1].ownerDocument, oe.map(s, x), f = 0; a > f; f++) u = s[f], Ie.test(u.type || "") && !Ee.access(u, "globalEval") && oe.contains(l, u) && (u.src ? oe._evalUrl && oe._evalUrl(u.src) : oe.globalEval(u.textContent.replace(Xe, "")))
            }
            return e
        }
        ...
        function E(e) {
            var t = G,
                n = Ve[e];
            return n || (n = k(e, t), "none" !== n && n || (ze = (ze || oe("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = ze[0].contentDocument, t.write(), t.close(), n = k(e, t), ze.detach()), Ve[e] = n), n
        }
        ...
        var ce = function(e) {
            function t(e, t, n, r) {
                ...
                if (!r && ((t ? t.ownerDocument || t : M) !== L && q(t), t = t || L, O)) {
                    if (11 !== g && (l = ve.exec(e)))
                        if (i = l[1]) {
                            if (9 === g) {
                                if (!(s = t.getElementById(i))) return n;
                                if (s.id === i) return n.push(s), n
                            } else if (h && (s = h.getElementById(i)) && _(t, s) && s.id === i) return n.push(s), n
                        } else {
                    ...
                    if (w.qsa && !X[e + " "] && (!I || !I.test(e))) {
                        if (1 !== g) h = t, d = e;
                            ...
                            for ((a = t.getAttribute("id")) ? a = a.replace(xe, "\\$&") : t.setAttribute("id", a = R), f = E(e), o = f.length, u = pe.test(a) ? "#" + a : "[id='" + a + "']"; o--;) f[o] = u + " " + p(f[o]);
            ...
            function d(e, t, n) {
                ...
                return t.first ? function(t, n, o) {
                    ...
                    if (s) {
                        ...
                        for (; t = t[r];)
                            if (1 === t.nodeType || i) {
                                if (l = t[R] || (t[R] = {}), u = l[t.uniqueID] || (l[t.uniqueID] = {}), (a = u[r]) && a[0] === B && a[1] === o) return c[2] = a[2];
            ...
            var b, w, T, C, k, E, N, S, j, D, A, q, L, H, O, I, P, F, _, R = "sizzle" + 1 * new Date,
                M = e.document,
                B = 0,
                $ = 0,
                W = n(),
            ...
            w = t.support = {}, k = t.isXML = function(e) {
                ...
                return r !== L && 9 === r.nodeType && r.documentElement ? (L = r, H = L.documentElement, O = !k(L), (n = L.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Te, !1) : n.attachEvent && n.attachEvent("onunload", Te)), w.attributes = i(function(e) {
                    ...
                    }, P = [], I = [], (w.qsa = me.test(L.querySelectorAll)) && (i(function(e) {
                    ...
                    })), (w.matchesSelector = me.test(F = H.matches || H.webkitMatchesSelector || H.mozMatchesSelector || H.oMatchesSelector || H.msMatchesSelector)) && i(function(e) {
                        w.disconnectedMatch = F.call(e, "div"), F.call(e, "[s!='']:x"), P.push("!=", oe)
                    }), I = I.length && new RegExp(I.join("|")), P = P.length && new RegExp(P.join("|")), t = me.test(H.compareDocumentPosition),
                    _ = t || me.test(H.contains) ? function(e, t) {
                        ...
                        return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !w.sortDetached && t.compareDocumentPosition(e) === n ? e === L || e.ownerDocument === M && _(M, e) ? -1 : t === L || t.ownerDocument === M && _(M, t) ? 1 : D ? ee(D, e) - ee(D, t) : 0 : 4 & n ? -1 : 1)
                    } : function(e, t) {
                        if (e === t) return A = !0, 0;
                        var n, r = 0,
                            i = e.parentNode,
                ...
                if ((e.ownerDocument || e) !== L && q(e), n = n.replace(ce, "='$1']"), w.matchesSelector && O && !X[n + " "] && (!P || !P.test(n)) && (!I || !I.test(n))) try {
                    var r = F.call(e, n);
                ...
                var t, n = [],
                    r = 0,
                    i = 0;
                if (A = !w.detectDuplicates, D = !w.sortStable && e.slice(0), e.sort(z), A) {
                        ...
                        return 1 === r && 0 === i ? function(e) {
                            ...
                            if (m) {
                                ...
                                if (h = [s ? m.firstChild : m.lastChild], s && y) {
                                    for (p = m, f = p[R] || (p[R] = {}), c = f[p.uniqueID] || (f[p.uniqueID] = {}), l = c[e] || [], d = l[0] === B && l[1], x = d && l[2], p = d && m.childNodes[d]; p = ++d && p && p[g] || (x = d = 0) || h.pop();)
                                        if (1 === p.nodeType && ++x && p === t) {
                                            c[e] = [B, d, x];
                                            break
                                        }
                                } else if (y && (p = t, f = p[R] || (p[R] = {}), c = f[p.uniqueID] || (f[p.uniqueID] = {}), l = c[e] || [], d = l[0] === B && l[1], x = d), x === !1)
                                    for (;
                                        (p = ++d && p && p[g] || (x = d = 0) || h.pop()) && ((a ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++x || (y && (f = p[R] || (p[R] = {}), c = f[p.uniqueID] || (f[p.uniqueID] = {}), c[e] = [B, x]), p !== t)););
            ...
            }, w.sortStable = R.split("").sort(z).join("") === R, w.detectDuplicates = !!A, q(), w.sortDetached = i(function(e) {
        ...
        oe.event = {
            ...
            add: function(e, t, n, r, i) {
                ...
                if (m)
                    for (n.handler && (o = n, n = o.handler, i = o.selector), n.guid || (n.guid = oe.guid++), (u = m.events) || (u = m.events = {}), (s = m.handle) || (s = m.handle = function(t) {
                        ...
                        }), t = (t || "").match(we) || [""], l = t.length; l--;) a = Me.exec(t[l]) || [], d = g = a[1], h = (a[2] || "").split(".").sort(), d && (f = oe.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d, f = oe.event.special[d] || {}, c = oe.extend({
                        type: d,
                        origType: g,
                        data: r,
                        handler: n,
            ...
            fix: function(e) {
                ...
                var t, n, r, i = e.type,
                    o = e,
                    s = this.fixHooks[i];
                for (s || (this.fixHooks[i] = s = Re.test(i) ? this.mouseHooks : _e.test(i) ? this.keyHooks : {}), r = s.props ? this.props.concat(s.props) : this.props, e = new oe.Event(o), t = r.length; t--;) n = r[t], e[n] = o[n];
        ...
        oe.extend({
            ...
            html: function(e) {
                return Ce(this, function(e) {
                    ...
                    if ("string" == typeof e && !$e.test(e) && !Pe[(Oe.exec(e) || ["", ""])[1].toLowerCase()]) {
        ...
        ! function() {
            ...
            a.style && (a.style.backgroundClip = "content-box", a.cloneNode(!0).style.backgroundClip = "", re.clearCloneStyle = "content-box" === a.style.backgroundClip, s.style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute", s.appendChild(a), oe.extend(re, {
                ...
                reliableMarginRight: function() {
                    ...
                    return n.style.cssText = a.style.cssText = "-webkit-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0", n.style.marginRight = n.style.width = "0", a.style.width = "1px",
                        Ke.appendChild(s), t = !parseFloat(e.getComputedStyle(n).marginRight), Ke.removeChild(s), a.removeChild(n), t
                }
            }))
        }();
            ...
            css: function(e, t) {
                return Ce(this, function(e, t, n) {
                    var r, i, o = {},
                        s = 0;
                    if (oe.isArray(t)) {
                        for (r = Je(e), i = t.length; i > s; s++) o[t[s]] = oe.css(e, t[s], !1, r);
                        return o
                    }
        ...
        oe.fn.extend({
            ...
            hasClass: function(e) {
                var t, n, r = 0;
                for (t = " " + e + " "; n = this[r++];)
                    if (1 === n.nodeType && (" " + M(n) + " ").replace(pt, " ").indexOf(t) > -1) return !0;
                return !1
            }
        });
        var dt = /\r/g,
        ...
        jt.href = mt.href, oe.extend({
            ...
            ajax: function(t, n) {
                function r(t, n, r, a) {
                    var l, f, y, x, w, C = n;
                    2 !== b && (b = 2, u && e.clearTimeout(u), i = void 0, s = a || "", T.readyState = t > 0 ? 4 : 0, l = t >= 200 && 300 > t || 304 === t, r && (x = U(p, T, r)), x = X(p, x, T, l), l ? (p.ifModified && (w = T.getResponseHeader("Last-Modified"), w && (oe.lastModified[o] = w), w = T.getResponseHeader("etag"), w && (oe.etag[o] = w)), 204 === t || "HEAD" === p.type ? C = "nocontent" : 304 === t ? C = "notmodified" : (C = x.state, f = x.data, y = x.error, l = !y)) : (y = C, !t && C || (C = "error", 0 > t && (t = 0))), T.status = t, T.statusText = (n || C) + "", l ? g.resolveWith(d, [f, C, T]) : g.rejectWith(d, [T, C, y]), T.statusCode(v), v = void 0, c && h.trigger(l ? "ajaxSuccess" : "ajaxError", [T, p, l ? f : y]), m.fireWith(d, [T, C]), c && (h.trigger("ajaxComplete", [T, p]), --oe.active || oe.event.trigger("ajaxStop")))
                }
        ...
        re.cors = !!It && "withCredentials" in It, re.ajax = It = !!It, oe.ajaxTransport(function(t) {
            var n, r;
...
var feed = new Instafeed({
    get: "user",
    userId: 253231379,
    accessToken: "253231379.d8d1d50.12cd71c254a4460ebfc758f1e7b87778",
...
feed.run(), $(document).ready(function() {
    $('nav a[href="#menu"]').on("click", function(e) {
        e.stopPropagation(), e.preventDefault(), $("body").addClass("js-menu-toggled")
    }), $("nav .close").on("click", function(e) {
        e.preventDefault(), $("body").removeClass("js-menu-toggled")
    }), $("body").on("click", function(e) {
        $("body").removeClass("js-menu-toggled")
    }), $('body nav[role="menu"]').on("click", function(e) {
